                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <select class="form-select text-center" id="category">
                                                ...
                                                ?>
                                                <option value="<?= $category_data["cat_id"]?>"><?= $category_data["cat_name"]?></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 border-end border-success">
                                            <div class="row">
                                                ...
                                                ?>
                                                <option value="<?= $color_data["clr_id"]?>" ><?= $color_data["clr_name"]?></option>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6 d-grid mt-3">
                                            ...
                                            <label for="" class="col-12 btn btn-primary" onclick="changeProductImage();" id="imageuploader">Upload Images</label>
                                        </div>
                                    </div>
                                </div>
