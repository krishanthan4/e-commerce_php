...
if(isset($_SESSION["u"])){
    ...
    $watchlist_rs = Database::search("SELECT * FROM `watchlist` INNER JOIN `product` ON watchllist.product_id= product.id INNER JOIN `product_has_color` ON product_has_color.product_id INNER JOIN ");
?>
       <div class="col-12">
                <div class="row">
