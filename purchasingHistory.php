...
<div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-1 bg-info text-center text-lg-start">
                                <label class="form-label text-white fs-6 py-5"><?= $invoice_data["invoice_id"]?></label>
                            </div>
                                ...
                                <div class="row">
                                    <div class="card mx-0 mx-lg-3 my-3" style="max-width: 540px;">
                                        <div class="row g-0">
                                            ...
                                            $details_rs = Database::search("SELECT * FROM `product` INNER JOIN `product_img` ON product.id = product_img.product_id = INNER JOIN `user` ON product.user_email = user.email WHERE `id`='".$invoice_data["product_id"]."'");
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"><b>Seller : </b><?= $product_data["fname"]?>." " <?= $product_data["lname"]?></p>
                                                    <p class="card-text"><b>Price : </b>Rs. <?= $product_data["price "]?> .00</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-lg-1 text-center text-lg-end">
                                <label class="form-label fs-4 py-5"><?= $invoice_data["qty"]?></label>
                            </div>
                            <div class="col-12 col-lg-2 text-center text-lg-end bg-info">
                                <label class="form-label fs-5 py-5 text-white">Rs. <?= $invoice_data["total"]?> .00</label>
                            </div>
                            <div class="col-12 col-lg-2 text-center text-lg-end">
                                <label class="form-label fs-5 px-3 py-5"><?= $invoice_data["date"] ?></label>
                            </div>
                            <div class="col-12 col-lg-3">
                                <div class="row">
                                    <div class="col-6 d-grid">
                                        <button
                                            class="btn btn-secondary rounded border border-1 border-primary mt-5 fs-5" onclick="addFeedback(<?= $invoice_data['invoice_id']?>);">
...
?>
                    ...
                    <!-- model -->
                    <div class="modal" tabindex="-1" id="feedbackmodal<?= $invoice_data["product_id"]?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-outline-primary" onclick="saveFeedback(<?= $invoice_data['product_id']?>);">Save Feedback</button>
                                </div>
                            </div>
                        </div>
                    </div>
